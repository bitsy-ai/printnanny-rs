...
//             let payload: models::PolymorphicPiEvent = serde_json::from_str(&s)?;
...
//             length_delimited,
//             tokio_serde::formats::SymmetricalJson::<PolymorphicPiEventRequest>::default(),
//         );
//         let maybe_msg: Option<PolymorphicPiEventRequest> = deserialized.try_next().await?;
