...
//         models::PiBootCommandRequest::RebootCommand => {
//             // publish RebootStarted event

//             let (subject, req) =
//                 build_boot_status_payload(&cmd, models::PiBootCommandRequest::RebootStarted, None)?;
//             nats_client.publish(subject.clone(), req).await?;
//             debug!(
//                 "nats.publish subject={} event_type={:?}",
//                 &subject,
//                 models::PiBootCommandRequest::RebootStarted
//             );
