...
PRINTNANNY_DEVICE_HOSTNAME="${PRINTNANNY_DEVICE_HOSTNAME:-cli-test}"
PRINTNANNY_INSTALL_DIR="${PRINTNANNY_INSTALL_DIR:-.tmp/cli-test}"
PRINTNANNY_DATA_DIR="${PRINTNANNY_DATA_DIR:-.tmp/cli-test/data}"
PRINTNANNY_CACERT_DIR="${PRINTNANNY_CACERT_DIR:-.tmp/cli-test/ca-certificates}"
