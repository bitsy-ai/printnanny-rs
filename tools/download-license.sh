...
PRINTNANNY_INSTALL_DIR="${PRINTNANNY_INSTALL_DIR:-.tmp/printnanny}"
PRINTNANNY_DATA_DIR="${PRINTNANNY_DATA_DIR:-.tmp/printnanny/data}"
PRINTNANNY_CACERT_DIR="${PRINTNANNY_CACERT_DIR:-.tmp/printnanny/ca-certificates}"
