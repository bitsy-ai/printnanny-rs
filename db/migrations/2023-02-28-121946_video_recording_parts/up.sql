CREATE TABLE video_recording_parts (
  ...
  buffer_ts UNSIGNED BIGINT NOT NULL,
  buffer_streamtime UNSIGNED BIGINT NOT NULL,
  buffer_runningtime UNSIGNED BIGINT NOT NULL,
  buffer_duration UNSIGNED BIGINT NOT NULL,
  buffer_offset UNSIGNED BIGINT NOT NULL,
  buffer_offset_end UNSIGNED BIGINT NOT NULL,
