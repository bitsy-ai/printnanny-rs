...
<div class="flex">
    ...
    <Transition name="fade" mode="out-in" :duration="{enter: 800, leave: 500}">
      ...
      <div class="flex items-center space-x-3 font-medium text-gray-600" v-else-if="store.status == ConnectionStatus.ConnectionError" >

      <div class="bg-red-500 flex-shrink-0 w-2.5 h-2.5 rounded-full" aria-hidden="true"></div>
